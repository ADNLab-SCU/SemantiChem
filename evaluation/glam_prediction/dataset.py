...
dataset_names = {
    ...
    'seq1_685_c_V7.3','seq1_685_c_V7.4','seq1_685_c_V7.5','seq1_685_c_V7.6','seq1_685_c_V7.7','seq1_685_c_V7.8','seq1_685_c_V7.9','seq1_685_c_V7.10',
    ],
...
class Dataset(InMemoryDataset):
    def __init__(self, root, dataset='bbbp', split='zidingyi', split_seed=1234, transform=None, pre_transform=None,
                 pre_filter=None):
        self.dataset = dataset  # random / random_nan / scaffold/zidingyi
    ...
    def split(self, type):
        ...
        if save_path.exists():
            ...
            torch.save([trn, val, test], save_path)
            print("type=sacffold,是这样。")    
            print(test)        
            return trn, val, test
        elif type == "zidingyi":
            df = pd.read_csv(self.raw_paths[0])
            train_size = len(df[df['type'] == 'train'])
            val_size = len(df[df['type'] == 'valid'])
    ...
    def tasks(self):
        d = {
            ...
            '20240112_dTm5':['dTm5'],
            '20240112_dTm10':['dTm10'],
            '20240112_dTm15_V2':['dTm15'],
            '20240112_dTm23':['dTm23'],
            'seq1_685_c_V7':['exp'],
            'seq1_835_c_dTm0_V7.1':['dTm0'],
            'seq1_835_c_dTm0_V7.2':['dTm0'],
            'seq1_835_c_dTm0_V7.3':['dTm0'],
            'seq1_835_c_dTm0_V7.4':['dTm0'],
            'seq1_835_c_dTm0_V7.5':['dTm0'],
            'seq1_835_c_dTm0_V7.6':['dTm0'],
            'seq1_835_c_dTm0_V7.7':['dTm0'],
            'seq1_835_c_dTm0_V7.8':['dTm0'],
            'seq1_835_c_dTm0_V7.9':['dTm0'],
            'seq1_835_c_dTm0_V7.10':['dTm0'],
            'seq1_835_c_dTm5_V7.1':['dTm5'],
            'seq1_835_c_dTm5_V7.2':['dTm5'],
            'seq1_835_c_dTm5_V7.3':['dTm5'],
            'seq1_835_c_dTm5_V7.4':['dTm5'],
            'seq1_835_c_dTm5_V7.5':['dTm5'],
            'seq1_835_c_dTm5_V7.6':['dTm5'],
            'seq1_835_c_dTm5_V7.7':['dTm5'],
            'seq1_835_c_dTm5_V7.8':['dTm5'],
            'seq1_835_c_dTm5_V7.9':['dTm5'],
            'seq1_835_c_dTm5_V7.10':['dTm5'],
            'seq1_835_c_dTm10_V7.1':['dTm10'],
            'seq1_835_c_dTm10_V7.2':['dTm10'],
            'seq1_835_c_dTm10_V7.3':['dTm10'],
            'seq1_835_c_dTm10_V7.4':['dTm10'],
            'seq1_835_c_dTm10_V7.5':['dTm10'],
            'seq1_835_c_dTm10_V7.6':['dTm10'],
            'seq1_835_c_dTm10_V7.7':['dTm10'],
            'seq1_835_c_dTm10_V7.8':['dTm10'],
            'seq1_835_c_dTm10_V7.9':['dTm10'],
            'seq1_835_c_dTm10_V7.10':['dTm10'],
            'seq1_835_c_dTm15_V7.1':['dTm15'],
            'seq1_835_c_dTm15_V7.2':['dTm15'],
            'seq1_835_c_dTm15_V7.3':['dTm15'],
            'seq1_835_c_dTm15_V7.4':['dTm15'],
            'seq1_835_c_dTm15_V7.5':['dTm15'],
            'seq1_835_c_dTm15_V7.6':['dTm15'],
            'seq1_835_c_dTm15_V7.7':['dTm15'],
            'seq1_835_c_dTm15_V7.8':['dTm15'],
            'seq1_835_c_dTm15_V7.9':['dTm15'],
            'seq1_835_c_dTm15_V7.10':['dTm15'],
            'seq1_835_c_6_dTm0_3':['exp'],
            'seq1_835_c_6_dTm0_4':['exp'],
            'seq1_835_c_6_dTm0_5':['exp'],
            'seq1_835_c_6_dTm0_6':['exp'],
            'seq1_835_c_6_dTm0_7':['exp'],
            'seq1_835_c_6_dTm0_8':['exp'],
            'seq1_835_c_6_dTm0_9':['exp'],
            'seq1_835_c_6_dTm0_10':['exp'],
            'seq1_835_c_6_dTm0_11':['exp'],
            'seq1_835_c_6_dTm0_12':['exp'],
            'seq1_835_c_6_dTm0_13':['exp'],
            'seq1_835_c_6_dTm0_14':['exp'],
            'seq1_835_c_6_dTm0_15':['exp'],
            'seq1_835_c_6_dTm0_16':['exp'],
            'seq1_685_c_dTm10':['exp'],
            'seq1_835_c_6_dTm5':['exp'],
            'seq1_835_c_6_dTm10':['exp'],
            'seq1_835_c_6_dTm15':['exp'],
            'G4IMFDA_01_7479':['exp'],
            '20240514_6952':['exp'],
            'G4FDA_6263_V1':['exp'],
            'G4FDA_6263_V2':['exp'],
            ...
            'G4FDA_6263_V15':['exp'],
            'G4FDA_6263_V16':['exp'],
            'G4FDA_6264_V15.1':['exp'],
            'G4FDA_6264_V15.2':['exp'],
            'G4FDA_6264_V15.3':['exp'],
            'G4FDA_6264_V15.4':['exp'],
            'G4FDA_6264_V15.5':['exp'],
            'G4FDA_6264_V15.6':['exp'],
            'G4FDA_6264_V15.7':['exp'],
            'G4FDA_6264_V15.8':['exp'],
            'G4FDA_6264_V15.9':['exp'],
            'G4FDA_6264_V15.10':['exp'],
            'G4FDA_6263_01':['exp'],
            'G4FDA_6263_ex01_V1':['exp'],
            'G4FDA_6263_ex01_V2':['exp'],
            'G4FDA_6263_ex01_V3':['exp'],
            'G4FDA_6263_ex01_V4':['exp'],
            'G4FDA_6263_ex01_V5':['exp'],
            'G4FDA_6263_ex01_V6':['exp'],
            'G4FDA_6263_ex01_V7':['exp'],
            'G4FDA_6263_ex01_V8':['exp'],
            'G4FDA_6263_ex01_V9':['exp'],
            'G4FDA_6263_ex01_V10':['exp'],
            'G4FDA_6263_ex01_V11':['exp'],
            'G4FDA_6263_ex01_V12':['exp'],
            'G4FDA_6263_ex01_V13':['exp'],
            'G4FDA_6263_ex01_V14':['exp'],
            'G4FDA_6263_ex01_V15':['exp'],
            'G4FDA_6263_ex01_V16':['exp'],
            'G4FDA_6263_ex01_V6.1':['exp'],
            'G4FDA_6263_ex01_V6.2':['exp'],
            'G4FDA_6263_ex01_V6.3':['exp'],
            'G4FDA_6263_ex01_V6.4':['exp'],
            'G4FDA_6263_ex01_V6.5':['exp'],
            'G4FDA_6263_ex01_V6.6':['exp'],
            'G4FDA_6263_ex01_V6.7':['exp'],
            'G4FDA_6263_ex01_V6.8':['exp'],
            'G4FDA_6263_ex01_V6.9':['exp'],
            'G4FDA_6263_ex01_V6.10':['exp'],
            '20241206_docking_2':['exp'],
            '20241206_docking_4':['exp'],
            '20241206_docking_6':['exp'],
            '20241206_docking_8':['exp'],
            '20241206_docking_10':['exp'],
            '20241215_docking_4_V1':['exp'],
            '20241215_docking_4_V2':['exp'],
            '20241215_docking_4_V3':['exp'],
            '20241215_docking_4_V4':['exp'],
            '20241215_docking_4_V5':['exp'],
            '20241215_docking_4_V6':['exp'],
            '20241215_docking_4_V7':['exp'],
            '20241215_docking_4_V8':['exp'],
            '20241215_docking_4_V9':['exp'],
            '20241215_docking_4_V10':['exp'],
            '20241215_docking_4_V11':['exp'],
            '20241215_docking_4_V12':['exp'],
            '20241215_docking_4_V13':['exp'],
            '20241215_docking_4_V14':['exp'],
            '20241215_docking_4_V15':['exp'],
            '20241215_docking_4_V16':['exp'],
